...
#include "main.h" // Garante que tipos como uint32_t e HAL_Status funcionem

// --- Máximo e mínimo da FAN ---
...
#define PURGE_INTERVAL      2300 //isso não é tempo é amp * s
...
#define H2_REACTION_PER_SEC_A      0.0004784//gasto de uma purga em g * s⁻¹A⁻¹
